...
import { ObjectModel } from "./ObjectStore"

export const ObjectSetModel = types.model("ObjectSet", {
  id: types.identifier,
  name: types.string,
...
export const ObjectSetStoreModel = types
...
export interface ObjectSetStore extends Instance<typeof ObjectSetStoreModel> {}

export { ObjectSetStoreModel as ObjectSetStore } 